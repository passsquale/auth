...
//go:generate minimock -i github.com/passsquale/auth/internal/repository.UserRepository -o user_repository_minimock.go -n UserRepositoryMock -p mocks
...
type UserRepositoryMock struct {
	...
	funcUpdate          func(ctx context.Context, wrap *model.UserUpdate) (err error)
	inspectFuncUpdate   func(ctx context.Context, wrap *model.UserUpdate)
...
func (mmUpdate *mUserRepositoryMockUpdate) Expect(ctx context.Context, wrap *model.UserUpdate) *mUserRepositoryMockUpdate {
	...
	mmUpdate.defaultExpectation.params = &UserRepositoryMockUpdateParams{ctx, wrap}
...
// ExpectWrapParam2 sets up expected param wrap for UserRepository.Update
func (mmUpdate *mUserRepositoryMockUpdate) ExpectWrapParam2(wrap *model.UserUpdate) *mUserRepositoryMockUpdate {
	if mmUpdate.mock.funcUpdate != nil {
		mmUpdate.mock.t.Fatalf("UserRepositoryMock.Update mock is already set by Set")
	}
	...
	mmUpdate.defaultExpectation.paramPtrs.wrap = &wrap

	return mmUpdate
}

// Inspect accepts an inspector function that has same arguments as the UserRepository.Update
func (mmUpdate *mUserRepositoryMockUpdate) Inspect(f func(ctx context.Context, wrap *model.UserUpdate)) *mUserRepositoryMockUpdate {
...
func (mmUpdate *mUserRepositoryMockUpdate) Set(f func(ctx context.Context, wrap *model.UserUpdate) (err error)) *UserRepositoryMock {
	if mmUpdate.defaultExpectation != nil {
...
// Then helper
func (mmUpdate *mUserRepositoryMockUpdate) When(ctx context.Context, wrap *model.UserUpdate) *UserRepositoryMockUpdateExpectation {
	if mmUpdate.mock.funcUpdate != nil {
		mmUpdate.mock.t.Fatalf("UserRepositoryMock.Update mock is already set by Set")
	}
	...
	expectation := &UserRepositoryMockUpdateExpectation{
		mock:   mmUpdate.mock,
		params: &UserRepositoryMockUpdateParams{ctx, wrap},
	}
...
func (mmUpdate *UserRepositoryMock) Update(ctx context.Context, wrap *model.UserUpdate) (err error) {
	mm_atomic.AddUint64(&mmUpdate.beforeUpdateCounter, 1)
	defer mm_atomic.AddUint64(&mmUpdate.afterUpdateCounter, 1)

	if mmUpdate.inspectFuncUpdate != nil {
		mmUpdate.inspectFuncUpdate(ctx, wrap)
	}

	mm_params := UserRepositoryMockUpdateParams{ctx, wrap}
	...
	if mmUpdate.UpdateMock.defaultExpectation != nil {
		...
		mm_got := UserRepositoryMockUpdateParams{ctx, wrap}
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.wrap != nil && !minimock.Equal(*mm_want_ptrs.wrap, mm_got.wrap) {
				mmUpdate.t.Errorf("UserRepositoryMock.Update got unexpected parameter wrap, want: %#v, got: %#v%s\n", *mm_want_ptrs.wrap, mm_got.wrap, minimock.Diff(*mm_want_ptrs.wrap, mm_got.wrap))
			}
	...
	if mmUpdate.funcUpdate != nil {
		return mmUpdate.funcUpdate(ctx, wrap)
	}
	mmUpdate.t.Fatalf("Unexpected call to UserRepositoryMock.Update. %v %v", ctx, wrap)
	return
}
