...
//go:generate minimock -i github.com/passsquale/auth/internal/service.UserService -o user_service_minimock.go -n UserServiceMock -p mocks
...
type UserServiceMock struct {
	...
	funcUpdate          func(ctx context.Context, userUpdate *model.UserUpdate) (err error)
	inspectFuncUpdate   func(ctx context.Context, userUpdate *model.UserUpdate)
...
func (mmUpdate *mUserServiceMockUpdate) Expect(ctx context.Context, userUpdate *model.UserUpdate) *mUserServiceMockUpdate {
	...
	mmUpdate.defaultExpectation.params = &UserServiceMockUpdateParams{ctx, userUpdate}
...
// ExpectUserUpdateParam2 sets up expected param userUpdate for UserService.Update
func (mmUpdate *mUserServiceMockUpdate) ExpectUserUpdateParam2(userUpdate *model.UserUpdate) *mUserServiceMockUpdate {
	if mmUpdate.mock.funcUpdate != nil {
		mmUpdate.mock.t.Fatalf("UserServiceMock.Update mock is already set by Set")
	}
...
func (mmUpdate *mUserServiceMockUpdate) Inspect(f func(ctx context.Context, userUpdate *model.UserUpdate)) *mUserServiceMockUpdate {
...
func (mmUpdate *mUserServiceMockUpdate) Set(f func(ctx context.Context, userUpdate *model.UserUpdate) (err error)) *UserServiceMock {
	if mmUpdate.defaultExpectation != nil {
...
// Then helper
func (mmUpdate *mUserServiceMockUpdate) When(ctx context.Context, userUpdate *model.UserUpdate) *UserServiceMockUpdateExpectation {
	if mmUpdate.mock.funcUpdate != nil {
		mmUpdate.mock.t.Fatalf("UserServiceMock.Update mock is already set by Set")
	}
	...
	expectation := &UserServiceMockUpdateExpectation{
		mock:   mmUpdate.mock,
		params: &UserServiceMockUpdateParams{ctx, userUpdate},
	}
...
func (mmUpdate *UserServiceMock) Update(ctx context.Context, userUpdate *model.UserUpdate) (err error) {
	...
	mm_params := UserServiceMockUpdateParams{ctx, userUpdate}
	...
	if mmUpdate.UpdateMock.defaultExpectation != nil {
		...
		mm_got := UserServiceMockUpdateParams{ctx, userUpdate}
	...
	mmUpdate.t.Fatalf("Unexpected call to UserServiceMock.Update. %v %v", ctx, userUpdate)
	return
}
