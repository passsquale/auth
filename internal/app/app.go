...
import (
	...
	"github.com/passsquale/auth/internal/interceptor"
	desc "github.com/passsquale/auth/pkg/user_v1"
	_ "github.com/passsquale/auth/statik"
...
func (a *App) runGRPCServer() error {
	log.Printf("GRPC server is running on %v", a.serviceProvider.GRPCConfig().Address())
